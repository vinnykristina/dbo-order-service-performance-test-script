...
export default async function () {
    ...
    const urlgetSoByAgentId = `https://moonlay-api.dbo.dev/order-srv/agent/${csvData[i].agent_id}/sales-orders`
    // console.log(urlDoById);

    group('Get So By Agent Id', function () {
        const getSoByAgentId = http.request('GET',urlgetSoByAgentId, "", {
            headers: {
