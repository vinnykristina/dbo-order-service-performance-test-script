...
export default async function () {
    ...
    const urlDoBySalesman = `https://moonlay-api.dbo.dev/order-srv/salesman/${csvData[i].salesman_id}/delivery-orders`
    // console.log(urlDoById);

    group('Get DO  By Salesman', function () {
        const getDoBySalesman = http.request('GET', urlDoBySalesman, "", {
            headers: {
