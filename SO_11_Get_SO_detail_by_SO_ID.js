...
export default async function () {
    ...
    const urlgetSoDetailBySoId = `https://moonlay-api.dbo.dev/order-srv/sales-orders/${csvData[i].id}/details`
    // console.log(urlDoById);

    group('Get So Detail By So Id', function () {
        const getSoDetailBySoId = http.request('GET',urlgetSoDetailBySoId, "", {
            headers: {
