...
export default async function () {
    ...
    const urlgetSosjUploadItemErrorsByRequestId = `https://moonlay-api.dbo.dev/order-srv/sosj/upload-histories/${csvData[i].request_id_sosj}/error-items`
    // console.log(urlDoById);

    group('Get Sosj Upload Item Errors By Request Id', function () {
        const getSosjUploadItemErrorsByRequestId = http.request('GET',urlgetSosjUploadItemErrorsByRequestId , "", {
            headers: {
