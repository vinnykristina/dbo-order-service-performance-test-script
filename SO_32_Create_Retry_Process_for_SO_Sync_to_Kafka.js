...
export default async function () {
    ...
    const urlcreateRetryProcessForSoSyncToKafka = `https://moonlay-api.dbo.dev/order-srv/sales-orders/retry-to-sync-kafka/${csvData[i].request_id}`
    // console.log(urlDoById);

    group('Create Retry Process For So Sync To Kafka', function () {
        const createRetryProcessForSoSyncToKafka = http.request('GET', urlcreateRetryProcessForSoSyncToKafka, "", {
            headers: {
