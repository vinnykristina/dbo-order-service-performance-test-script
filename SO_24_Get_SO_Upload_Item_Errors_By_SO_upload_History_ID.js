...
export default async function () {
    ...
    const urlgetSoUploadItemErrorsBySoUploadHistoryId = `https://moonlay-api.dbo.dev/order-srv/sales-orders/upload-histories/${csvData[i].upload_history_id_so}/error-items`
    // console.log(urlDoById);

    group('Get So Upload Item Errors By So Upload History Id', function () {
        const getSoUploadItemErrorsBySoUploadHistoryId = http.request('GET', urlgetSoUploadItemErrorsBySoUploadHistoryId, "", {
            headers: {
