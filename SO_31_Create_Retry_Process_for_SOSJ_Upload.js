...
export default async function () {
    ...
    const urlcreateRetryProcessForSosjUpload = `https://moonlay-api.dbo.dev/order-srv/sosj/upload-sosj/retry/${csvData[i].request_id}`
    // console.log(urlDoById);

    group('Create Retry Process For Sosj Upload', function () {
        const createRetryProcessForSosjUpload = http.request('GET', urlcreateRetryProcessForSosjUpload, "", {
            headers: {
