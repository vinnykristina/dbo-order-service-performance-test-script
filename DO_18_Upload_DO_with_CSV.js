...
export default async function () {
    ...
    group('Upload Do With CSV', function () {
        ...
        const dataUploadDO = {
            "file": `${csvData[i].UrlFileDO}`,
            "use_master": "true"
        }
        const uploadDoWithCsv = http.request('POST', 'https://moonlay-api.dbo.dev/order-srv/upload-delivery-orders', JSON.stringify(dataUploadDO), {
            headers: {
