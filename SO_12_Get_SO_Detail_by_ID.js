...
export default async function () {
    ...
    const urlgetSoDetailById = `https://moonlay-api.dbo.dev/order-srv/sales-orders/details/${csvData[i].so_detail_id}`
    // console.log(urlDoById);

    group('Get So Detail By Id', function () {
        const getSoDetailById = http.request('GET', urlgetSoDetailById ,"", {
            headers: {
