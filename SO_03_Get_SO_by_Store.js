...
export default async function () {
    ...
    const urlgetSoByStoreId = `https://moonlay-api.dbo.dev/order-srv/order-srv/stores/${csvData[i].store_id}/sales-orders`
    // console.log(urlDoById);

    group('Get So By Store Id', function () {
        const getSoByStoreId = http.request('GET', urlgetSoByStoreId, "", {
            headers: {
