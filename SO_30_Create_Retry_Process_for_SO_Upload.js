...
export default async function () {
    ...
    const urlcretaeRetryProcessForSOUpload = `https://moonlay-api.dbo.dev/order-srv/sales-orders/upload-sales-orders/retry/${csvData[i].request_id}`
    // console.log(urlDoById);

    group('Create Retry Process For SO Upload', function () {
        const cretaeRetryProcessForSOUpload = http.request('GET', urlcretaeRetryProcessForSOUpload, "", {
            headers: {
