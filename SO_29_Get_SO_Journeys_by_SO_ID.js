...
export default async function () {
    ...
    const urlgetSoJourneysBySoId = `https://api.dbo.dev/order-srv/sales-orders/${csvData[i].id}/journeys`
    // console.log(urlDoById);

    group('Get So Journeys By So Id', function () {
        const getSoJourneysBySoId = http.request('GET',urlgetSoJourneysBySoId,"", {
            headers: {
